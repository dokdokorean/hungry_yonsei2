...
//천원의 아침
document.getElementById('mor-mon-menu1').innerText='야채하이라이스덮밥'
document.getElementById('mor-mon-menu2').innerText='왕피자춘권*갈릭딥핑소스'
document.getElementById('mor-mon-menu3').innerText='미니동그랑땡'
...
//점심메뉴 4번
document.getElementById('c-menu2-mon').innerText='김.돈'//메뉴
document.getElementById('c-menu3-mon').innerText=''//가격

//점심메뉴 5번 
document.getElementById('d-menu2-mon').innerText='가라아게동'//메뉴
document.getElementById('d-menu3-mon').innerText=''//가격

//점심메뉴 6번 
document.getElementById('e-menu2-mon').innerText='콩국수'//메뉴
...
//점심메뉴 4번
document.getElementById('c-menu2-tue').innerText='닭갈비덮밥'//메뉴
document.getElementById('c-menu3-tue').innerText=''//가격

//점심메뉴 5번 
document.getElementById('d-menu2-tue').innerText='특식 유산슬덮밥'//메뉴
document.getElementById('d-menu3-tue').innerText=''//가격

//점심메뉴 6번 
document.getElementById('e-menu2-tue').innerText='베이컨갈릭볶음밥*어묵소떡'//메뉴
...
//점심메뉴 3번 
document.getElementById('b-menu2-wed').innerText='나물비빔밥'//메뉴
document.getElementById('b-menu3-wed').innerText=''//가격

//점심메뉴 4번
document.getElementById('c-menu2-wed').innerText='닭곰탕'//메뉴
document.getElementById('c-menu3-wed').innerText=''//가격

//점심메뉴 5번 
document.getElementById('d-menu2-wed').innerText='특식 스테이크동'//메뉴
document.getElementById('d-menu3-wed').innerText=''//가격

//점심메뉴 6번 
document.getElementById('e-menu2-wed').innerText='히야시라멘'//메뉴
...
//점심메뉴 2번 
document.getElementById('a-menu2-thur').innerText='얼큰소콩나물해장국'//메뉴
document.getElementById('a-menu3-thur').innerText=''//가격

//점심메뉴 3번 
document.getElementById('b-menu2-thur').innerText='냉면'//메뉴
document.getElementById('b-menu3-thur').innerText=''//가격

//점심메뉴 4번
document.getElementById('c-menu2-thur').innerText='우삼겹규동'//메뉴
document.getElementById('c-menu3-thur').innerText=''//가격

//점심메뉴 5번 
document.getElementById('d-menu2-thur').innerText='스팸마요덮밥'//메뉴
document.getElementById('d-menu3-thur').innerText=''//가격

//점심메뉴 6번
document.getElementById('e-menu2-thur').innerText='들깨수제비'//메뉴
...
//점심메뉴 3번 
document.getElementById('b-menu2-fri').innerText='중화 잡채밥'//메뉴
document.getElementById('b-menu3-fri').innerText=''//가격

//점심메뉴 4번
document.getElementById('c-menu2-fri').innerText='모듬까스'//메뉴
