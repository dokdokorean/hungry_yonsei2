...
//천원의 아침
document.getElementById('mor-mon-menu1').innerText='수목샘 측의'
document.getElementById('mor-mon-menu2').innerText='메뉴 제공이 늦어지고 있습니다'
document.getElementById('mor-mon-menu3').innerText='죄송합니다ㅠ'

document.getElementById('k-menu2-mon').innerText='-'//메뉴
document.getElementById('k-menu3-mon').innerText=''//가격

//점심메뉴 2번 
document.getElementById('a-menu2-mon').innerText='수목샘 측의'//메뉴
document.getElementById('a-menu3-mon').innerText=''//가격

//점심메뉴 3번 
document.getElementById('b-menu2-mon').innerText='메뉴 제공이'//메뉴
document.getElementById('b-menu3-mon').innerText=''//가격

//점심메뉴 4번
document.getElementById('c-menu2-mon').innerText='늦어지고 있습니다'//메뉴
document.getElementById('c-menu3-mon').innerText=''//가격

//점심메뉴 5번 
document.getElementById('d-menu2-mon').innerText='죄송합니다ㅠ'//메뉴
...
//천원의 아침
document.getElementById('mor-tue-menu1').innerText='수목샘 측의'
document.getElementById('mor-tue-menu2').innerText='메뉴 제공이 늦어지고 있습니다'
document.getElementById('mor-tue-menu3').innerText='죄송합니다ㅠ'
...
//점심메뉴 2번 
document.getElementById('a-menu2-tue').innerText='수목샘 측의'//메뉴
document.getElementById('a-menu3-tue').innerText=''//가격

//점심메뉴 3번 
document.getElementById('b-menu2-tue').innerText='메뉴 제공이'//메뉴
document.getElementById('b-menu3-tue').innerText=''//가격

//점심메뉴 4번
document.getElementById('c-menu2-tue').innerText='늦어지고 있습니다'//메뉴
document.getElementById('c-menu3-tue').innerText=''//가격

//점심메뉴 5번 
document.getElementById('d-menu2-tue').innerText='죄송합니다ㅠ'//메뉴
