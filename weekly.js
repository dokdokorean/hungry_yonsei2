...
document.getElementById('mor-mon-menu2').innerText='메뉴 전달이 지연되고 있습니다'
document.getElementById('mor-mon-menu3').innerText='양해 부탁드립니다'
...
//점심메뉴 3번 
document.getElementById('b-menu2-mon').innerText='메뉴 전달이 지연되고 있습니다'//메뉴
document.getElementById('b-menu3-mon').innerText=''//가격

//점심메뉴 4번
document.getElementById('c-menu2-mon').innerText='양해 부탁드립니다.'//메뉴
